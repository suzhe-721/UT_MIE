...
% r                 yaw rate [rad/s]
%
% Last updated: Pravin Wedage 2022-10-25
...
% rotation matrix
frame_rotation = [cos(theta) sin(theta) 0; -sin(theta) cos(theta) 0; 0 0 1];

Y_rotation = [cos(theta) 0 -sin(theta);0 1 0;sin(theta) 0 cos(theta)];

X_rotation = [1 0 0; 0 cos(theta) sin(theta) 0 -sin(theta) cos(theta)];
% Aerodynamic Coefficients 
% compute the nondimensional aerodynamic coefficients here

Cl = 0.266;
Cd = 0.0174;
rho = 1.112;  %%%later change to 35000 ft air density
S = 5500;


% aerodynamic forces and moments
% compute the aerodynamic forces and moments here
F_lift = 1/2*rho*Va^2*S*Cl;

F_drag = 1/2*rho*Va^2*S*Cd;
